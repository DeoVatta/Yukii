// ✅ Refactor spreadsheetConnect.js agar tidak bergantung pada file yukii-creds.json
...
async function deteksiKategori(pesan) {
  ...
  if (!sheet) {
    throw new Error('❌ Sheet "kategori" tidak ditemukan!');
  }
...
module.exports.tulisKeTransaksi = tulisKeTransaksi;
module.exports.deteksiKategori = deteksiKategori;
